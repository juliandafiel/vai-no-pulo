...
describe('VehiclesService', () => {
    ...
    describe('create', () => {
        it('should create a new vehicle', async () => {
            ...
            mockPrismaService.vehicle.create.mockResolvedValue(Object.assign(Object.assign({}, mockVehicle), createData));
    ...
    describe('updateStatus', () => {
        it('should approve a vehicle and send email', async () => {
            const vehicleWithDriver = Object.assign(Object.assign({}, mockVehicle), { driver: mockDriver });
            mockPrismaService.vehicle.findUnique.mockResolvedValue(vehicleWithDriver);
            mockPrismaService.vehicle.update.mockResolvedValue(Object.assign(Object.assign({}, mockVehicle), { status: 'APPROVED' }));
            ...
            expect(mockMailService.sendVehicleApprovedEmail).toHaveBeenCalledWith('driver@example.com', 'Test Driver', 'Toyota Corolla', 'ABC1234', 'Approved!');
        });
        it('should reject a vehicle and send email', async () => {
            const vehicleWithDriver = Object.assign(Object.assign({}, mockVehicle), { driver: mockDriver });
            mockPrismaService.vehicle.findUnique.mockResolvedValue(vehicleWithDriver);
            mockPrismaService.vehicle.update.mockResolvedValue(Object.assign(Object.assign({}, mockVehicle), { status: 'REJECTED' }));
            ...
            expect(mockMailService.sendVehicleRejectedEmail).toHaveBeenCalledWith('driver@example.com', 'Test Driver', 'Toyota Corolla', 'ABC1234', 'Documents unclear');
        });
    ...
    describe('updateOrCreateVehicle', () => {
        ...
        it('should create a new vehicle if none exists', async () => {
            ...
            mockPrismaService.vehicle.create.mockResolvedValue(Object.assign(Object.assign({}, mockVehicle), { status: 'PENDING' }));
        ...
        it('should update existing vehicle and reset status to PENDING', async () => {
            ...
            mockPrismaService.vehicle.update.mockResolvedValue(Object.assign(Object.assign({}, mockVehicle), { status: 'PENDING', approvedBy: null, approvedAt: null }));
            const result = await service.updateOrCreateVehicle('driver-1', vehicleData);
            expect(result.status).toBe('PENDING');
