...
let VehiclesController = class VehiclesController {
    ...
    updateMyVehicle(updateVehicleDto, req) {
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get vehicles of authenticated driver' }),
...
__decorate([
    (0, common_1.UseGuards)((0, passport_1.AuthGuard)('jwt')),
    (0, common_1.Put)('my-vehicle'),
    (0, swagger_1.ApiOperation)({ summary: 'Update or create vehicle of authenticated driver' }),
    (0, swagger_1.ApiBody)({
        schema: {
            example: {
                brand: 'Fiat',
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", void 0)
], VehiclesController.prototype, "updateMyVehicle", null);
__decorate([
    (0, common_1.UseGuards)((0, passport_1.AuthGuard)('jwt')),
    (0, common_1.Get)(),
