...
describe('UsersService', () => {
    ...
    describe('create', () => {
        it('should create a new user', async () => {
            ...
            mockPrismaService.user.create.mockResolvedValue(Object.assign(Object.assign({}, mockUser), createData));
    ...
    describe('approve', () => {
        it('should approve a user', async () => {
            const approvedUser = Object.assign(Object.assign({}, mockUser), { profileStatus: 'APPROVED', approvedAt: expect.any(Date), approvedBy: 'admin-1' });
    ...
    describe('reject', () => {
        it('should reject a user with reason', async () => {
            const rejectedUser = Object.assign(Object.assign({}, mockUser), { profileStatus: 'REJECTED', rejectedAt: expect.any(Date), rejectionReason: 'Invalid documents' });
    ...
    describe('updateProfile', () => {
        it('should update user profile', async () => {
            const updatedUser = Object.assign(Object.assign({}, mockUser), { name: 'Updated Name' });
        ...
        it('should return driver userType for DRIVER role', async () => {
            const updatedDriver = Object.assign(Object.assign({}, mockUser), { role: 'DRIVER', name: 'Updated Driver' });
    ...
    describe('findByGoogleId', () => {
        it('should find user by Google ID', async () => {
            const googleUser = Object.assign(Object.assign({}, mockUser), { googleId: 'google-123' });
    ...
    describe('createFromGoogle', () => {
        it('should create user from Google data', async () => {
            ...
            mockPrismaService.user.create.mockResolvedValue(Object.assign(Object.assign({}, mockUser), googleData));
